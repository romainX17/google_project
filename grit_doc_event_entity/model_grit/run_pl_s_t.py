...
class NERTransformer(BaseTransformer):
    ...
    def test_step(self, batch, batch_nb):
        ...
        for b in range(bs):
            ...
            position_seq.append(out_position_id_list[:idx+1])
            # get pred_extract
            p_extract = []
            sep_cnt = 0
            position_buf = []
        ...
        return {"pred_seq": pred_seq, "pred_extract": pred_extract, "docid": docids,"positions":position_seq}
    ...
    def test_epoch_end(self, outputs):
        ...
        for x in outputs:
            ...
            # preds_log
            for docid, p_seq, pos_seq in zip(docids, pred_seq, positions_seq):
                if docid not in preds_log:
                    ...
                    preds_log[docid]["positions"] = " ".join([str(i) for i in pos_seq])
